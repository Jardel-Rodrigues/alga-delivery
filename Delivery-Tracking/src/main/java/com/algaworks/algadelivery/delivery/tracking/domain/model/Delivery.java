...
public class Delivery {
	...
	public void markAsDelivered() {
		this.changeStatusTo(DeliveryStatus.DELIVEDED);
	...
	private void verifyIfCanBrPlaced() {
		if(!isFilled()) {
			throw new DomainExcetion();
		}
	...
	private void changeStatusTo(DeliveryStatus newStatus) {
		if(newStatus != null && this.getStatus().canNotChangeTo(newStatus)) {
			throw new DomainExcetion("Invalid status transiton from " + getStatus() + " to " + newStatus);
		}
